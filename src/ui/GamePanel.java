...
public class GamePanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        drawTopBar(g2d);
        drawPath(g2d, gameManager.getPath());
        drawEntities(g2d);
    ...
    private void drawTopBar(Graphics2D g2d) {
        ...
        Rectangle rect = gameManager.getStartWaveButtonRect();
        ...
        Rectangle pauseRect = gameManager.getPauseButtonRect();
        ...
        Rectangle restartRect = gameManager.getRestartButtonRect();
    ...
    private void drawPlacementPreview(Graphics2D g2d) {
        ...
        int radius = (int) previewTower.getRange();
        g2d.setColor(new Color(0, 0, 0, 45));
        g2d.fillOval(mouseX - radius, mouseY - radius, radius * 2, radius * 2);
        g2d.setColor(new Color(0, 0, 0, 80));
        g2d.drawOval(mouseX - radius, mouseY - radius, radius * 2, radius * 2);
    }
